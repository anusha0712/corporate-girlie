...
- **Use `claude-opus-4-7` as the model string** in `/api/generate.js`. If much time has passed since this spec was written, verify it's still current at https://docs.claude.com/en/docs/about-claude/models/overview — model strings change.
